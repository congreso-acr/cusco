...
// HTML template with the aesthetic button boxes
...
<body class="subpage-body">
    ...
    <!-- Sección Mapa Interactivo y Botonera Estética -->
    <section id="mapa-seccion" class="map-section">
        <div class="container reveal">
            <div class="section-header center">
                ...
                <p>Haz clic en cualquier polígono del mapa o en los cuadros interactivos de abajo para ir directamente a la ficha detallada.</p>
            </div>
            ...
            <div class="map-interactive-container">
                <div class="map-wrapper">
                    ...
                    <div id="map-tooltip" class="map-tooltip">
                        ...
                        <span class="tooltip-hint">👆 Haz clic para ver información</span>
                    </div>
                </div>
            ...
            <!-- CUADROS / BOTONES ESTÉTICOS DE CADA ACR -->
            <div class="acr-quick-buttons-grid">
                <!-- 1. Choquequirao -->
                <a href="#acr-choquequirao" class="acr-button-card btn-choquequirao" data-acr="choquequirao">
                    <div class="btn-card-icon-box">
                        <span class="btn-card-emoji">🏔️</span>
                    </div>
                    <div class="btn-card-content">
                        <span class="btn-card-badge">103,814.39 ha</span>
                        <h3>ACR Choquequirao</h3>
                        <p class="btn-card-location">📍 La Convención · Anta</p>
                    </div>
                    <div class="btn-card-action">
                        <span class="btn-card-arrow">Explorar →</span>
                    </div>
                </a>

                <!-- 2. Tres Cañones -->
                <a href="#acr-tres-canones" class="acr-button-card btn-trescanones" data-acr="tres-canones">
                    <div class="btn-card-icon-box">
                        <span class="btn-card-emoji">🏛️</span>
                    </div>
                    <div class="btn-card-content">
                        <span class="btn-card-badge">39,485.11 ha</span>
                        <h3>ACR Tres Cañones</h3>
                        <p class="btn-card-location">📍 Espinar</p>
                    </div>
                    <div class="btn-card-action">
                        <span class="btn-card-arrow">Explorar →</span>
                    </div>
                ...
                <!-- 3. Ausangate -->
                <a href="#acr-ausangate" class="acr-button-card btn-ausangate" data-acr="ausangate">
                    <div class="btn-card-icon-box">
                        <span class="btn-card-emoji">❄️</span>
                    </div>
                    <div class="btn-card-content">
                        <span class="btn-card-badge">66,514.77 ha</span>
                        <h3>ACR Ausangate</h3>
                        <p class="btn-card-location">📍 Quispicanchi · Canchis</p>
                    </div>
                    <div class="btn-card-action">
                        <span class="btn-card-arrow">Explorar →</span>
                    </div>
                ...
                <!-- 4. Chuyapi Urusayhua -->
                <a href="#acr-chuyapi-urusayhua" class="acr-button-card btn-chuyapi" data-acr="chuyapi-urusayhua">
                    <div class="btn-card-icon-box">
                        <span class="btn-card-emoji">💧</span>
                    </div>
                    <div class="btn-card-content">
                        <span class="btn-card-badge">80,190.00 ha</span>
                        <h3>ACR Chuyapi Urusayhua</h3>
                        <p class="btn-card-location">📍 La Convención</p>
                    </div>
                    <div class="btn-card-action">
                        <span class="btn-card-arrow">Explorar →</span>
                    </div>
                ...
                <!-- 5. Q'eros Kosñipata -->
                <a href="#acr-qeros-kosnipata" class="acr-button-card btn-qeros" data-acr="qeros-kosnipata">
                    <div class="btn-card-icon-box">
                        <span class="btn-card-emoji">🌿</span>
                    </div>
                    <div class="btn-card-content">
                        <span class="btn-card-badge">55,319.97 ha</span>
                        <h3>ACR Q'eros–Kosñipata</h3>
                        <p class="btn-card-location">📍 Paucartambo</p>
                    </div>
                    <div class="btn-card-action">
                        <span class="btn-card-arrow">Explorar →</span>
                    </div>
    ...
    <section class="acrs-detail-section">
        <div class="container">
            ...
            <article id="acr-tres-canones" class="acr-card-detailed reveal">
                ...
                <div class="acr-photo-gallery">
                    <figure class="gallery-item main-feature">
                        <!-- TODO: Reemplazar imagen por foto de Tres Cañones -->
            ...
            <article id="acr-ausangate" class="acr-card-detailed reveal">
                ...
                <div class="acr-photo-gallery">
                    <figure class="gallery-item main-feature">
                        <!-- TODO: Reemplazar imagen por foto de Ausangate -->
            ...
            <article id="acr-chuyapi-urusayhua" class="acr-card-detailed reveal">
                ...
                <div class="acr-photo-gallery">
                    <figure class="gallery-item main-feature">
                        <!-- TODO: Reemplazar imagen por foto de Chuyapi Urusayhua -->
            ...
            <article id="acr-qeros-kosnipata" class="acr-card-detailed reveal">
                ...
                <div class="acr-photo-gallery">
                    <figure class="gallery-item main-feature">
                        <!-- TODO: Reemplazar imagen por foto de Q'eros Kosñipata -->
...
fs.writeFileSync(path.join(__dirname, 'acrs.html'), htmlTemplate, 'utf8');
console.log('acrs.html written with aesthetic buttons grid!');
