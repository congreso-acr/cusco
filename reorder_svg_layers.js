...
for (let i = 0; i < lines.length; i++) {
    ...
    if (acrStartIndex !== -1 && lines[i].includes('<g id="Departamental_INEI_2023_geogpsperu_SuyoPomalia">')) {
        acrEndIndex = i - 1; // line before <g opacity="0.7"...
        break;
    }
}
...
// Combined Foreground Layer containing:
// 1. Interactive Polygons on Top
// 2. Interactive Badges on Top
const foregroundLayer = `
<!-- ==========================================
     INTERACTIVE FOREGROUND LAYER: POLYGONS & BADGES
     ========================================== -->
${acrGroupContent}
...
// Replace old Labels layer with the new foreground layer
...
console.log('Successfully reordered layers and injected interactive foreground layer into acrs.html!');
